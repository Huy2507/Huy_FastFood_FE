    ...
    return (
        <nav className="flex items-center justify-between bg-red-600 px-4 py-2 text-2xl text-white">
            <div className="flex w-full items-center md:flex-row">
                ...
                {/* Logo */}
                <h1 className="mx-auto flex text-2xl font-bold md:mx-0">
                    FastFood
                </h1>

                {/* Navigation Links */}
                <div className="absolute left-0 top-[6%] w-full bg-red-600 md:static md:top-0 md:flex">
                    <ul
                        className={`mr-3 flex transform flex-col gap-3 pl-4 transition-all duration-500 ease-in-out md:flex md:flex-row md:items-center ${
                            isMenuOpen
